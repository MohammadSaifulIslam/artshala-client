        ...
        <section className='bg-black text-white'>
            <footer className="my-container footer mt-24 p-10">
                ...
                <div>
                    ...
                    <Link to='/menu' className="link link-hover">Instructors</Link>
                    <Link to='/blog' className="link link-hover">Classes</Link>
                ...
                <div>
                    ...
                    <div className='text-white'>
                        <Link to='/' className="font-bold text-xl md:text-3xl mb-5" style={{ fontFamily: ['Bruno Ace SC', 'cursive'] }}>Artshala</Link>
                    ...
                    <div className="form-control w-80">
                        ...
                        <div className="relative">
                            ...
                            <button className="btn bg-primary absolute top-0 right-0 rounded-l-none ">Subscribe</button>
                        </div>
                    </div>
                </div>
            </footer>
            <hr className='border-white'/>
            <p className='text-center text-white py-4'>@Copiright reserved by Artshala</p>
        </section>
    );
};
