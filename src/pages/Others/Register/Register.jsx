    ...
    return (
        <section className='my-container my-10 '>
            <form onSubmit={handleSubmit(onSubmit)} className='mx-5 rounded-xl shadow-xl  md:w-1/3 md:mx-auto px-5 py-10 border-2 border-[#FFB347]'>
                <h4 className='text-[#FFB347] text-2xl font-bold mb-5 text-center'>Register Form</h4>
                ...
                <p className='text-center mt-2'>Already have an account? <Link to='/login' className='text-[#FFB347] underline'>Login</Link></p>
                <SocialLogin />
            </form>
        </section>
    );
